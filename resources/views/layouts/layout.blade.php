    ...
    ***********************************-->
    <div id="main-wrapper">
                ...
                <div class="header-right">
                    <ul class="clearfix">
                        <li class="icons dropdown">
                            <font color="black" style="padding-right: 15px">Nama User</font>
        ...
        ***********************************-->
        <div class="footer">
            <div class="copyright">
                <p>Copyright &copy; Designed & Developed by <a href="https://themeforest.net/user/quixlab">INVENTORY KASIR</a> {{ date("Y") }}</p>
            </div>
        </div>
        <!--**********************************
            Footer end
